...
<title>Online Exam System || ONLINE EXAMINATION SYSTEM </title>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/developer.jpg" width=100 height=100 alt="Shahadot Hossain" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Shahadot Hossain</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">01793-012312</h4>
		<h4 style="font-family:'typo' ">nil.180109s.pust.ac.bd</h4>
		<h4 style="font-family:'typo' ">Pabna University of Science and Technology</h4></div></div>
		</p>
      </div>
